...
#let slides-fmt(handout: false, notes: false, body) = {
  ...
  speaker-note[
    Γεια σας! Είμαι ο Γιάννης και από εδώ είναι ο Χριστόφορος. Μαζί φτιάξαμε την πτυχιακή μας με τίτλο "Χημικός Χαρακτηρισμός Αιωρούμενων Ατμοσφαιρικών Σωματιδίων", η οποία ασχολείται με τον χαρακτηρισμό και την ποσοτικοποίηση των ρύπων από την φθορά ελαστικών σε δείγματα σκόνης δρόμου.
  ]
