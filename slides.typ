...
#align(center + horizon, image("assets/ghanadi2025-environment.jpg", height: 85%))
...
#speaker-note[
	...
	Επίσης παρατηρούνται διάφορες Νευροτοξικές και Καρδιοτοξικές επιδράσεις, αλλά και συμπεριφορικές διαταραχές, οι οποίες οφείλονται σε μηχανισμούς όπως οξειδωτικό στρες, μιτοχονδριακή δυσλειτουργία και νευροφλεγμονώδεις αποκρίσεις. Από εδώ και πέρα συνεχίζει ο Χριστόφορος.
]
...
#speaker-note[
	Γεια σας και από εμένα. Για την μέθοδο, χρησιμοποιήθηκε υγρός χρωματογράφος υψηλής απόδοσης με φασματόμετρο μαζών τετραπολικού ανιχνευτή χρόνου πτήσης, ο οποίος είναι κατάλληλος για ενώσεις μεγάλου μοριακού βάρους και προσφέρει υψηλή διακριτική ικανότητα.
	Η ροή του διαλύτη είναι σταθερή στα $0.2 "mL/min"$, ο όγκος έγχυσης στα $5 "μL"$ και η θερμοκρασία σταθερή στους $45 degree C$.
]
...
#speaker-note[
	Στα πλαίσια της εργασίας έγινε συλλογή δειγμάτων σκόνης από τον δρόμο σε διάφορες περιοχές της αθήνας. Τουλάχιστον $100 "mg"$ σκόνης μεταφέρθηκαν σε αεροστεγώς κλειστό τρυβλίο στο εργαστήριο και αποθηκεύτηκαν στο ψυγείο μέχρι να αναλυθούν.
]

== Χάρτης δειγματοληψίας

#align(center + horizon, image("assets/map1.png", height: 85%))
...
#slide(self => {
	...
	let speakernotes = (
		[Κοσκινίζουμε την σκόνη δείγματος και ζυγίζουμε από αυτή $100 "mg"$.],
		[Αυτή τοποθετείται πάνω σε καθαρό φίλτρο μέσα σε κωνική φιάλη. Προσθέτουμε στην κωνική φιάλη $10 "μL"$ διαλύματος #C_6PPD-Q-d5() και #C_BTR-d4() συγκέντρωσης $5 "μg/mL"$ το καθένα.],
		[Εκχυλίζουμε δύο φορές σε υπερήχους με $10 "mL"$ #DCM κάθε φορά, και άλλη μία φορά με $10 "mL"$ #ACN, συλλέγοντας συνολικά $30 "mL"$ εκχυλίσματος.],
		[To εκχύλισμα φιλτράρεται στα $0.45 "μm"$ και εισέρχεται σε σφαιρική φιάλη.],
		[Συμπυκνώνουμε το περιεχόμενο της σφαιρικής φιάλης χρησιμοποιώντας περιστροφικό εξατμιστή μέχρι περίπου $0.5 "mL"$, και το παραλαμβάνουμε με πλαστική σύριγγα, μεταφέροντας το σε φιαλίδιο των $6 "mL"$. Ξεπλένουμε την σφαιρική δύο φορές με $1 "mL"$ #DCM, μεταφέροντας επίσης στο φιαλίδιο. Το περιεχόμενο του φιαλιδίου φιλτράρεται στα $0.22 "μm"$.],
		[Το περιεχόμενο της φιάλης συμπυκνώνεται υπό ρεύμα αζώτου μέχρι ξηρού. Η ανασύσταση γίνεται με $100 "μL"$ διαλύματος #ACN με #C_BP-d10() συγκέντρωσης $50 "ng/mL"$. Ακολουθεί ανάλυση στο #HPLC.],
	)
...
#align(center + horizon, image("assets/map2.png", height: 85%))
